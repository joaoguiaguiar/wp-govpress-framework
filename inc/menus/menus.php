<?php
/**
 * Menus personalizados - GovPress Framework
 */
 ...
 */
function inst_registrar_menus() {
    register_nav_menus(array(
        'menu-principal' => 'Menu Principal',
    ));
}
add_action('init', 'inst_registrar_menus');

/**
 * Walker para menu principal (sem submenus)
 */
class INST_Main_Menu_Walker extends Walker_Nav_Menu {
 ...
 */
class INST_Menu_Lista_Walker extends Walker_Nav_Menu {
    function start_lvl(&$output, $depth = 0, $args = null) {
        // Não cria sub-listas
    }
