...
if (!function_exists('inst_menu_personalizado_home')) {
    add_action('blocksy:header:after', 'inst_menu_personalizado_home');

    function inst_menu_personalizado_home() {
            ...
            <section class="hero-menu menu-1" id="menu-1">
                ...
                <div class="menu-and-search">
                    ...
                    <nav class="menu__items">
                        <?php
                        // Busca itens do menu principal registrado no init
