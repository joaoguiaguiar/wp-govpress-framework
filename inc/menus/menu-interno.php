...
if (!function_exists('inst_menu_personalizado_interno')) {
    add_action('blocksy:header:after', 'inst_menu_personalizado_interno');

    function inst_menu_personalizado_interno() {
