<?php
/**
 * Widget Menu Lista - GovPress Framework
 */
 ...
 */
class INST_Menu_Lista_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'inst_menu_lista_widget',
            'Menu Lista - Framework',
            array('description' => 'Exibe menu WordPress em estrutura modular personalizada')
        );
    }
 ...
 * Registra o widget
 */
function inst_registrar_widget_menu_lista() {
    register_widget('INST_Menu_Lista_Widget');
}
add_action('widgets_init', 'inst_registrar_widget_menu_lista', 10);