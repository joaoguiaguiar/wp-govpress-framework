<?php
/**
 * Widgets do Menu - GovPress Framework
 */
 ...
 */
function inst_registrar_sidebar_menu() {
...
add_action('widgets_init', 'inst_registrar_sidebar_menu', 5); 

/**
 * Conteúdo alternativo para o widget de menu
 */
function inst_conteudo_widget_menu() {
    ob_start();
